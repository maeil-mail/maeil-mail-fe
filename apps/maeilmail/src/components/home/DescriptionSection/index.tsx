      ...
      <div className={descriptionSectionInnerWrapper}>
        <div className={descriptionItemContainer}>
          ...
          <div className={descriptionContentWrapper}>
            ...
            <div className={mobileDescriptionTitle}>매일 아침 7시, 메일함을 확인해보세요</div>
        ...
        <div className={descriptionItemContainer}>
          ...
          <div className={descriptionContentWrapper}>
            ...
            <div className={mobileDescriptionTitle}>답안 자료도 함께 보내드리고 있어요</div>
            <div className={`${descriptionDetail} ${disappearOnMobile}`}>
              내가 신청한 분야의 기술 면접 질문을
              <br />
              확인하고 스스로 답해보세요
        ...
        <div className={descriptionItemContainer}>
          ...
          <div className={descriptionContentWrapper}>
            ...
            <div className={mobileDescriptionTitle}>매일 쌓인 질문은 따로 정리해놨어요</div>
            <div className={`${descriptionDetail} ${disappearOnMobile}`}>
              내가 신청한 분야의 기술 면접 질문을
              <br />
              확인하고 스스로 답해보세요
